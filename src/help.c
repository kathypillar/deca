// help.c
// modified from help.c from nano
...
void help_init(void)
{
	...
	if (currmenu & (MWHEREIS|MREPLACE)) {
		htx[0] = N_("Search Command Help Text\n\n "
				"Input the words or characters you would like to "
		...
		htx[0] = N_("Main deca help text\n\n "
				"The deca editor is a fork of GNU nano 7.2 designed "
				"to add features while keeping the spirt the same. "
				...
				"messages and the current cusor position.  ");
