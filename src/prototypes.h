// protypes.h
// modified from prototypes.h from nano
...
extern bool tailmatched;
extern bool headmatched;
...
#endif
#if defined(ENABLE_DECARC) && (!defined(DECA_TINY) || defined(ENABLE_JUSTIFY))
...
#if !defined(DECA_TINY) || defined(ENABLE_SPELLER) || defined (ENABLE_LINTER) || defined (ENABLE_FORMATTER)
...
#endif
#if !defined(DECA_TINY) || defined(ENABLED_WRAPORJUSTIFY)
