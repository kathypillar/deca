// color.c
// modified from color.c from nano
...
/* Initialize the color pairs for deca's interface. */
void set_interface_colorpairs(void)
{
	...
	/* Initialize the color pairs for deca's interface elements. */
